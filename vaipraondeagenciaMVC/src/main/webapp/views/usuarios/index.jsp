...
<html lang="pt">
  ...
  <meta charset="utf-8">
    ...
    <title>Vai pra onde? A agência que te leva pro mundo!</title>
  </head>
  <body>
  
    <nav class="navbar col-12 position-fixed navbar-expand-lg navbar-dark bg-dark" style="z-index: 999;">
        <div class="container-fluid col-11 m-auto">
          <a class="navbar-brand" href="index.html">Vai pra onde? Sua agência de viagens!</a>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p>Venha conhecer a cidade maravilhosa! Em até 12x sem juros!</p>
            </div>
          </div>
          <div class="carousel-item">
            <img src="./londres.png" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Londres em até 12x sem juros</h5>
              <p>Conheça a terra da rainha junto com a gente!</p>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p>O caribe brasileiro. Em até 12x sem juros.</p>
            </div>
          </div>
        </div>
      ...
      <form>
          ...
          <select id="destino" name="destino">
              ...
              <option value="bh">Japão</option>
              <option value="bh">Argentina</option>
          </select>

          <br>
          <label for="destino">De onde está saindo:</label>
          <select id="destino" name="destino">
              <option value="rio">Rio de Janeiro</option>
              <option value="sp">São Paulo</option>
              <option value="bh">Belo Horizonte</option>
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              ...
              <br>
              <br>
              <h5 class="card-title">Brasília por apenas R$250</h5>
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              ...
              <br>
              <br>
              <h5 class="card-title">São Paulo por R$100</h5>
              <p class="card-text">Ponte área saindo do RJ.</p>
              <a href="https://www.cvc.com.br/?utm_source=google&utm_medium=cpc_br&utm_content=2023_ic_t-roas_31-mar_perene&gclid=CjwKCAjwtuOlBhBREiwA7agf1kWxEazX16JMmlqBRyVScbW2jFRMzQE0aUdHzbGWxGiIEZI8_B7SQhoCZNYQAvD_BwE" class="btn btn-primary">Confira!</a>
            </div>
          </div>
        </div>
